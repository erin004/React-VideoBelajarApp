    ...
    <div className="bg-[#FEFDF6]">
      ...
      <section className="mt-10 px-4 sm:px-6">
        <div className="w-full max-w-[1200px] mx-auto relative rounded-[10px] overflow-hidden h-[400px]">
          <img src={headerImg} alt="Hero Banner" className="absolute inset-0 w-full h-full object-cover" />
          ...
          <div className="relative z-10 w-full px-6 md:px-[150px] py-10 flex flex-col items-center text-center h-full justify-center">
            <h2
                className="text-white text-[24px] sm:text-[32px] md:text-[40px] lg:text-[48px] font-bold leading-tight font-secondary">
      ...
      <section className="mt-6 sm:mt-12 px-4 sm:px-6">
        <div className="w-full max-w-[1200px] mx-auto">
            ...
            <p className="text-[14px] sm:text-[16px] font-medium text-gray-500 mb-6 sm:mb-8 font-primary leading-relaxed">
            Jelajahi Dunia Pengetahuan Melalui Pilihan Kami!
            </p>

            {/* Tabs / Filter Button */}
            <div className="flex flex-wrap gap-4 sm:gap-12 text-[14px] sm:text-[16px] font-medium text-gray-500 font-primary">
